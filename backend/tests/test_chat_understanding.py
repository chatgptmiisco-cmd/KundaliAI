...
from app.services.chat_understanding import ChatUnderstanding, classify_message, compute_out_of_domain_redirects
...
async def test_classify_message_falls_back_to_keyword_detection_without_openai_configured():
    ...
    # question, never extract a memory note (that needs real language
    ...
    assert understanding.user_note is None
